...
public class RegexList {
	...
	public static void main(String[] args) throws UnsupportedEncodingException{
		Pattern pattern = Pattern.compile(RegexList.number_hyphen_regexp);
		String str ="23412-41_234";
	 ...
	 * 圆括号
	 */
	public static final String round_brackets_content_regexp = "(?<=\\()(.+?)(?=\\))";
	
	/**
	 * 方括号
	 */
	public static final String square_brackets_content_regexp = "(?<=\\[)(.+?)(?=\\])";
	
	/**
	 * 花括号
	 */
	public static final String braces_content_regexp = "(?<=\\{)(.+?)(?=\\})";
	
	/**
	 * 尖括号
	 */
	public static final String angle_brackets_content_regexp = "(?<=\\<)(.+?)(?=\\>)";
